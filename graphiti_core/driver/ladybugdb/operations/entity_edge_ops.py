...
from graphiti_core.driver.ladybugdb.operations.record_parsers import parse_kuzu_entity_edge
...
class LadybugDBEntityEdgeOperations(EntityEdgeOperations):
    async def save(
        self,
        ...
        query = get_entity_edge_save_query(GraphProvider.LADYBUGDB)
        if tx is not None:
